...
function Register() {
    ...
    return (
        <form onSubmit={handleSubmit} className=''>
            ...
            <h2 className='text-3xl font-bold text-center py-2 '>Create an Account</h2>
            <div className='w-[350px] md:w-[450px]  flex flex-col gap-2 m-auto p-2' >
                <div>
                    ...
                    <input type='text' value={data.name} name='fullname' className='bg-purple-300 font-medium rounded-lg px-2 py-1 placeholder:text-gray-600 outline-none w-80 md:w-full' onChange={handleChange} placeholder='Enter full Name' />
                </div>
                <div>
                    <label className='font-semibold text-lg'>
                        Email :
